...
"SELECT * FROM umaue_tedhenat ORDER BY ID_Tedhenat DESC");
?>
<!DOCTYPE HTML>
<!--
	Urban by TEMPLATED
				...
				<!-- Section -->
					...
					<form method="post" action="#">
											<div class="col align-center">
												<hr/>
												<h4>KËRKO TË DHËNAT  PËR MODIFIKIM</h4>
												<hr/>
												<div class="12u$">
													<ul class="actions">
														<li><input type="text" name="modifiko" id="name" value="" placeholder="Titulli ose Pamja_Faqes" /></li>
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"modifiko_tdh.php?ID_Tedhenat=$rresht[ID_Tedhenat]\" class='button' class='button primary'>Modifiko</a> </td>";				
	}
